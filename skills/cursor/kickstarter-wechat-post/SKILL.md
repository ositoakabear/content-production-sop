...
- 展示真实产品、人物、Logo、UI、活动或文档时必须使用真实来源素材，并遵循通用图片优先级：第一方官网/官方众筹页原图优先，可信媒体或公开来源其次。不得用文生图复刻或替代真实对象；文生图仅用于抽象机制、场景组合、商业模式解释或明确标注为“示意图”的概念视觉。完整规则见 `../../../docs/assets/image-asset-workflow.md`。
...
- 标题图文案固定为两级：栏目名“本周好物观察” + 官方产品名。不得添加 slogan、核心卖点、功能短语、情绪金句、众筹成绩或重复文章标题。
...
- `../../../docs/assets/image-asset-workflow.md`：图片资产目录、命名与验证规则。
- `../../../playbooks/kickstarter/kickstarter-product-post-sop.md`：Kickstarter 产品观察文章的主 SOP。
